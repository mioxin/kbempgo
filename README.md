...
- **Язык:** Go
- **База данных:** Любая поддерживаемая SQL (например, PostgreSQL, MySQL). Возможно сохранение данных в файлы DepsResponse.json и sotr.Json (ограниченная функциональность)
- **API:** gRPC, REST
