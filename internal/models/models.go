...
// Models is interface of objects from web source representation
// datasource id implementation one.
...
// models.Dep implementation json data from web source
// It implements Sotr data in the "Text" field
type Dep struct {
